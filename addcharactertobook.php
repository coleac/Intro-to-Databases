...
if(!($stmt = $mysqli->prepare("INSERT INTO Books_Characters(BId, CId) VALUES (?,?)"))){
...
if(!($stmt->bind_param("ii",$_POST['Book'],$_POST['Character']))){
...
if(!$stmt->execute()){
	...
	header("Location:http://web.engr.oregonstate.edu/~colea/cs340/Characters-And-Books.php");//return to page w/ updated table
	//echo "Added " . $stmt->affected_rows . " rows to Books_Characters."; //if successful display confirmation
}
?>