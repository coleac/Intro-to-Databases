...
if(!($stmt = $mysqli->prepare("SELECT Characters.Id, Characters.Fname, Characters.Lname, Species.Name, Vocations.Title FROM Characters INNER JOIN Species ON Species.Id=Characters.Species INNER JOIN Vocations ON Vocations.Id=Characters.Vocation WHERE Species.Id= ? GROUP BY Characters.Id"))){
...
if(!($stmt->bind_param("i",$_POST['Species']))){
