...
if(!($stmt = $mysqli->prepare("INSERT INTO Vocations(Title, Duties) VALUES (?,?)"))){
...
if(!($stmt->bind_param("ss",$_POST['VTitle'],$_POST['Duties']))){
...
if(!$stmt->execute()){
	...
	header("Location:http://web.engr.oregonstate.edu/~colea/cs340/Vocations.php");//return to page w/ updated table
	//echo "Added " . $stmt->affected_rows . " rows to Vocations."; //if successful display confirmation
}
?>