...
if(!($stmt = $mysqli->prepare("INSERT INTO Species(Name, Characteristics) VALUES (?,?)"))){
...
if(!($stmt->bind_param("ss",$_POST['SName'],$_POST['Characteristics']))){
...
if(!$stmt->execute()){
	...
	header("Location:http://web.engr.oregonstate.edu/~colea/cs340/Species.php");//return to page w/ updated table
	//echo "Added " . $stmt->affected_rows . " rows to Species."; //if successful display confirmation
}
?>