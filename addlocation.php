...
if(!($stmt = $mysqli->prepare("INSERT INTO Locations(Name, Ruler) VALUES (?,?)"))){
...
if(!($stmt->bind_param("ss",$_POST['LName'],$_POST['Ruler']))){
...
if(!$stmt->execute()){
	...
	header("Location:http://web.engr.oregonstate.edu/~colea/cs340/Locations.php");//return to page w/ updated table
	//echo "Added " . $stmt->affected_rows . " rows to Locations."; //if successful display confirmation
}
?>