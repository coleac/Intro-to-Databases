...
if(!($stmt = $mysqli->prepare("INSERT INTO Characters(Fname, Lname, Species, Vocation) VALUES (?,?,?,?)"))){
...
if(!($stmt->bind_param("ssii",$_POST['FirstName'],$_POST['LastName'],$_POST['Species'],$_POST['Vocation']))){
...
if(!$stmt->execute()){
	...
	//echo "Added " . $stmt->affected_rows . " rows to Characters."; //if successful display confirmation
}
